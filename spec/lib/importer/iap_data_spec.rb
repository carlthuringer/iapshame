...
describe "Importer::IAPData" do
  ...
  describe '#import_preview_page_genre' do
    it "gets the genre out of the preview page" do
      disable_net_connect!
      stub_apple_app_preview_with_iap_get_200
      response = Client::AppleAppPreviewPage.fetch_preview("https://itunes.apple.com/us/app/4.0.9.6/id854533196?mt=8&uo=2")
      imported = Importer::IAPData.import_preview_page_genre(response.document)
      expect(imported).to eq(6014)
    end
  end
end
